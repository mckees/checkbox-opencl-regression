...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Parse json file generated by `intel_gpu_tool -J` to check if GPU is being used"
    )
    parser.add_argument(
        "logfile", help="Path to the log file to parse."
    )
